...
- In RL an agent learns from experiences it gains by interacting with the environment. In Supervised Learning it is not possible to affect the environment.
